...
public class StylesheetsTest {
    ...
    public void Internal_Stylesheet_Is_Applied_Correctly() {
        Pane root = TestCompiler.newInstance(this, "Internal_Stylesheet_Is_Applied_Correctly", """
    ...
    public void Multiple_Internal_Stylesheets_Are_Applied_Correctly() {
        Pane root = TestCompiler.newInstance(this, "Multiple_Internal_Stylesheets_Are_Applied_Correctly", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Complex_Internal_Stylesheet_Is_Compiled_Correctly() {
        Pane root = TestCompiler.newInstance(this, "Complex_Internal_Stylesheet_Is_Compiled_Correctly", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Internal_Stylesheet_Works_With_External_Stylesheet() {
        Pane root = TestCompiler.newInstance(this, "Internal_Stylesheet_Works_With_External_Stylesheet", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Stylesheet_For_Incompatible_Property_Fails() {
        MarkupException ex = assertThrows(MarkupException.class,
            () -> TestCompiler.newInstance(this, "Stylesheet_For_Incompatible_Property_Fails", """
                <?import javafx.scene.layout.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <prefWidth>
                        <fx:stylesheet>
    ...
    public void Stylesheet_With_Invalid_Rule_Fails() {
        MarkupException ex = assertThrows(MarkupException.class,
            () -> TestCompiler.newInstance(this, "Stylesheet_With_Invalid_Rule_Fails", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Stylesheet_With_Invalid_Declaration_Fails() {
        MarkupException ex = assertThrows(MarkupException.class,
            () -> TestCompiler.newInstance(this, "Stylesheet_With_Invalid_Declaration_Fails", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Stylesheet_Without_Rule_Fails() {
        MarkupException ex = assertThrows(MarkupException.class,
            () -> TestCompiler.newInstance(this, "Stylesheet_Without_Rule_Fails", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Stylesheet_With_Unmatched_Brackets_Fails() {
        MarkupException ex = assertThrows(MarkupException.class,
            () -> TestCompiler.newInstance(this, "Stylesheet_With_Unmatched_Brackets_Fails", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <stylesheets>
    ...
    public void Inline_Style_Is_Applied_Correctly() {
        Pane root = TestCompiler.newInstance(this, "Inline_Style_Is_Applied_Correctly", """
                <?import javafx.scene.layout.*?>
                <?import javafx.scene.control.*?>
                <Pane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                    <style>
