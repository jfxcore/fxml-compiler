...
public class PropertyAssignmentTest {
    ...
    @Nested
    public class BasicInvariantsTest {
        @Test
        public void Duplicate_AttributeProperty_And_ElementProperty_Is_Invalid() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Duplicate_AttributeProperty_And_ElementProperty_Is_Invalid", """
        ...
        public void Duplicate_AttributeProperty_Is_Invalid() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Duplicate_AttributeProperty_Is_Invalid", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <GridPane prefWidth="10">
                            <prefWidth>20</prefWidth>
        ...
        public void Duplicate_ElementProperty_Is_Invalid() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Duplicate_ElementProperty_Is_Invalid", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <GridPane prefWidth="10">
                            <prefWidth>20</prefWidth>
        ...
        public void Property_Without_Value_Is_Invalid() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Property_Without_Value_Is_Invalid", """
                    <?import java.lang.*?>
        ...
        public void Property_With_Multiple_Values_Is_Invalid() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Property_With_Multiple_Values_Is_Invalid", """
                    <?import java.lang.*?>
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
    ...
    public class CoercionTest {
        ...
        public void AttributeValue_Is_Coerced_To_String() {
            Button root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_String", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            text="Hello!"/>
                """);
        ...
        public void AttributeValue_Is_Coerced_To_String_And_Preserves_Whitespace() {
            Button root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_String_And_Preserves_Whitespace", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            text="  Hello!  "/>
                """);
        ...
        public void AttributeValue_Is_Coerced_To_Number() {
            Button root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Number", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            prefWidth="123.5"/>
                """);
        ...
        public void AttributeValue_Is_Coerced_To_InfiniteDouble() {
            Button root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_InfiniteDouble", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            prefWidth="-Infinity"/>
                """);
        ...
        public void AttributeValue_Is_Coerced_To_Boolean() {
            Button root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Boolean", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
        ...
        public void AttributeValue_Is_Coerced_To_Enum() {
            GridPane root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Enum", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                              alignment="CENTER"/>
                """);
        ...
        public void AttributeValue_Of_Chained_Property_Is_Coerced_To_Enum() {
            ListView<?> root = TestCompiler.newInstance(
                this, "AttributeValue_Of_Chained_Property_Is_Coerced_To_Enum", """
                    <?import javafx.scene.control.*?>
        ...
        public void AttributeValue_Is_Coerced_To_Static_Field_Of_TargetType() {
            GridPane root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Static_Field_Of_TargetType", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
        ...
        public void AttributeValue_Is_Coerced_To_Static_Field_Of_Raw_GenericClass() {
            GridPane root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Static_Field_Of_Raw_GenericClass", """
                    <?import javafx.scene.layout.*?>
                    <?import org.jfxcore.compiler.PropertyAssignmentTest.CoercionTest.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void AttributeValue_Is_Coerced_To_Insets() {
            GridPane root = TestCompiler.newInstance(
                this, "AttributeValue_Is_Coerced_To_Insets", """
                    <?import javafx.scene.layout.*?>
        ...
        public void AttributeValue_Comma_Separated_List_Is_Coerced_To_Insets() {
            GridPane root = TestCompiler.newInstance(
                this, "AttributeValue_Comma_Separated_List_Is_Coerced_To_Insets", """
                    <?import javafx.scene.layout.*?>
        ...
        public void AttributeValue_Unmatchable_Coercion_Throws_Exception() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "AttributeValue_Unmatchable_Coercion_Throws_Exception", """
                    <?import javafx.scene.layout.*?>
        ...
        public void ElementValue_Is_Coerced_To_String() {
            Button root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_String", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <text>Hello!</text>
                    </Button>
        ...
        public void ElementValue_Is_Coerced_To_String_And_Removes_Insinificant_Whitespace() {
            Button root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_String_And_Removes_Insignificant_Whitespace", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <text>
                            foo
        ...
        public void ElementValue_Is_Coerced_To_Number() {
            Button root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_Number", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void ElementValue_Is_Coerced_To_InfiniteDouble() {
            Button root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_InfiniteDouble", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void ElementValue_Is_Coerced_To_Boolean() {
            Button root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_Boolean", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void ElementValue_Is_Coerced_To_Enum() {
            GridPane root = TestCompiler.newInstance(
                this, "ElementValue_Is_Coerced_To_Enum", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <alignment>
                            CENTER
        ...
        public void ElementValue_Of_Chained_Property_Is_Coerced_To_Enum() {
            ListView<?> root = TestCompiler.newInstance(
                this, "ElementValue_Of_Chained_Property_Is_Coerced_To_Enum", """
                    <?import javafx.scene.control.*?>
                    <ListView xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void Comma_Separated_String_Is_Coerced_To_Collection() {
            GridPane root = TestCompiler.newInstance(
                this, "Comma_Separated_String_Is_Coerced_To_Collection", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
        ...
        public void Comma_Separated_String_Is_Coerced_In_Collection_Initializer() {
            GridPane root = TestCompiler.newInstance(
                this, "Comma_Separated_String_Is_Coerced_In_Collection_Initializer", """
                    <?import java.util.*?>
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <fx:define>
        ...
        public void Comma_Separated_String_Initializer_For_DoubleList_Fails() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "Comma_Separated_String_Initializer_For_DoubleList_Fails", """
                    <?import java.util.*?>
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <fx:define>
        ...
        public void StaticProperty_PropertyText_Is_Coerced_To_Integer() {
            GridPane root = TestCompiler.newInstance(
                this, "StaticProperty_PropertyText_Is_Coerced_To_Integer", """
                    <?import javafx.scene.layout.*?>
                    <GridPane xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void StaticProperty_PropertyText_Is_Coerced_To_Insets() {
            VBox root = TestCompiler.newInstance(
                this, "StaticProperty_PropertyText_Is_Coerced_To_Insets", """
                    <?import javafx.scene.layout.*?>
        ...
        public void StaticProperty_ElementText_Is_Coerced_To_Insets() {
            VBox root = TestCompiler.newInstance(
                this, "StaticProperty_ElementText_Is_Coerced_To_Insets", """
                    <?import javafx.scene.layout.*?>
                    <VBox xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void StaticProperty_PropertyText_Cannot_Be_Coerced_To_Insets() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "StaticProperty_PropertyText_Cannot_Be_Coerced_To_Insets", """
                    <?import javafx.scene.layout.*?>
                    <VBox xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void StaticProperty_String_Cannot_Be_Assigned_To_Insets() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "StaticProperty_String_Cannot_Be_Assigned_To_Insets", """
                    <?import java.lang.*?>
                    <?import javafx.scene.layout.*?>
                    <VBox xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
                        <Pane>
        ...
        public void NamedColor_Is_Coerced_To_Paint() {
            Button root = TestCompiler.newInstance(
                this, "NamedColor_Is_Coerced_To_Paint", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            textFill="red"/>
                """);
        ...
        public void WebColor_Is_Coerced_To_Paint() {
            Button root = TestCompiler.newInstance(
                this, "WebColor_Is_Coerced_To_Paint", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            textFill="#12345678"/>
                """);
        ...
        public void WebColor_Is_Coerced_To_Named_Color_Field() {
            Button root = TestCompiler.newInstance(
                this, "WebColor_Is_Coerced_To_Named_Color_Field", """
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
                            textFill="#ff0000"/>
                """);
    ...
    public class ConstantsTest {
        ...
        public void Constant_Is_Referenced_With_FxConstant() {
            Button button = TestCompiler.newInstance(
                this, "Constant_Is_Referenced_With_FxConstant", """
                    <?import java.lang.*?>
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void Constant_Is_Referenced_With_InContext_FxConstant() {
            Button button = TestCompiler.newInstance(
                this, "Constant_Is_Referenced_With_InContext_FxConstant", """
                    <?import java.lang.*?>
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml"
        ...
        public void FxConstant_And_Child_Content_Cannot_Be_Used_At_Same_Time() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "FxConstant_And_Child_Content_Cannot_Be_Used_At_Same_Time", """
                    <?import java.lang.*?>
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void FxConstant_And_FxValue_Content_Cannot_Be_Used_At_Same_Time() {
            MarkupException ex = assertThrows(MarkupException.class, () -> TestCompiler.newInstance(
                this, "FxConstant_And_FxValue_Content_Cannot_Be_Used_At_Same_Time", """
                    <?import java.lang.*?>
                    <?import javafx.scene.control.*?>
                    <Button xmlns="http://jfxcore.org/javafx" xmlns:fx="http://jfxcore.org/fxml">
        ...
        public void FxConstant_Resolves_Fully_Qualified_Name() {
            TableView<?> tableView = TestCompiler.newInstance(
                this, "FxConstant_Can_Use_Fully_Qualified_Name", """
                    <?import javafx.scene.control.*?>
