...
public class CollectionBindingMatrixTest {
    ...
    public void ParameterizedTest(Execution execution) throws Exception {
        ...
        if (source.startsWith("${[..")) name = "_bindContent_" + source.substring(5, source.length() - 2);
        else if (source.startsWith("#{[..")) name = "_bindContentBidirectional_" + source.substring(5, source.length() - 2);
        else if (source.startsWith("$[..")) name = "_content_" + source.substring(4, source.length() - 1);
