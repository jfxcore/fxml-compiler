...
public enum ErrorCode {
    ...
    RESERVED_NAMESPACE_CANNOT_BE_REBOUND,
    EXPECTED_TOKEN,
    EXPECTED_IDENTIFIER,
    UNEXPECTED_TOKEN,
    ...
    UNEXPECTED_MARKUP_EXTENSION,
    DUPLICATE_PREFIX_DECLARATION,
    INVALID_EXPRESSION,
    ...
    DUPLICATE_RESOURCE_DECLARATION,
    INVALID_RESOURCE_MEDIA_TYPE,
    DUPLICATE_RESOURCE_MEDIA_TYPE_PARAMETER,
    UNSUPPORTED_RESOURCE_CHARSET,
    UNREPRESENTABLE_RESOURCE_CHARACTER,
    ...
    CANNOT_POPULATE_MAP_WITHOUT_KEYS,
    TYPE_ARGUMENT_OUT_OF_BOUND,
    NUM_TYPE_ARGUMENTS_MISMATCH,
    TYPE_ARGUMENT_NOT_REFERENCE,
    ...
    AMBIGUOUS_METHOD_OR_CONSTRUCTOR_CALL,
    METHOD_NOT_STATIC,
    INVALID_ARITHMETIC_OPERAND,
    ARITHMETIC_EXPRESSION_TOO_COMPLEX,
    RAW_COMPARABLE_OPERAND,
    INVALID_CHAINED_RELATION,
    INVALID_RELATIONAL_OPERANDS,
    INVALID_IDENTITY_OPERANDS,
    ...
    INVALID_MARKUP_EXTENSION_USAGE,
