...
public class MapSourceAdapterChangeGenerator extends ClassGenerator {
    ...
    public void emitFields(BytecodeEmitContext context) {
        createField(SOURCE_FIELD, MapChangeListenerChangeDecl()).setModifiers(Modifier.PRIVATE);
    }
    ...
    public void emitMethods(BytecodeEmitContext context) {
        ...
        constructor = createConstructor(ObservableMapDecl()).setModifiers(Modifier.PRIVATE);
        initChangeMethod = createMethod(INIT_CHANGE_METHOD_NAME, voidDecl(), MapChangeListenerChangeDecl());
    }
    ...
    public void emitCode(BytecodeEmitContext context) {
        ...
        TypeDeclaration type = MapChangeListenerChangeDecl();
        ...
        createFieldDelegateMethod(this, ObjectDecl(), SOURCE_FIELD, type, "getValueAdded");
        createFieldDelegateMethod(this, ObjectDecl(), SOURCE_FIELD, type, "getValueRemoved");
        createFieldDelegateMethod(this, ObjectDecl(), SOURCE_FIELD, type, "getKey");
    }
