...
public enum CurlyTokenType implements TokenType {
    ...
    PLUS("+", CurlyTokenClass.NONE),
    MINUS("-", CurlyTokenClass.NONE),
    STAR("*", CurlyTokenClass.NONE),
    LESS_THAN_OR_EQUAL("<=", CurlyTokenClass.NONE),
    GREATER_THAN_OR_EQUAL(">=", CurlyTokenClass.NONE),
    VALUE_EQUALITY("==", CurlyTokenClass.NONE),
    VALUE_INEQUALITY("!=", CurlyTokenClass.NONE),
    IDENTITY_EQUALITY("===", CurlyTokenClass.NONE),
    IDENTITY_INEQUALITY("!==", CurlyTokenClass.NONE),
    LOGICAL_AND("&&", CurlyTokenClass.NONE),
    LOGICAL_OR("||", CurlyTokenClass.NONE),
    NOT("!", CurlyTokenClass.NONE),
    BOOLIFY("!!", CurlyTokenClass.NONE),
